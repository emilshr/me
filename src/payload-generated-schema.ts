...
export const enum_pages_blocks_accordion_variant = pgEnum(
  "enum_pages_blocks_accordion_variant",
  ["single", "multiple"],
);
...
export const pages_blocks_accordion_accordion_items = pgTable(
  "pages_blocks_accordion_accordion_items",
  {
    ...
    topRightTitle: varchar("top_right_title"),
    bottomRightSubTitle: varchar("bottom_right_sub_title"),
    content: jsonb("content"),
    value: varchar("value"),
  },
  (columns) => [
    index("pages_blocks_accordion_accordion_items_order_idx").on(
      columns._order,
    ),
    index("pages_blocks_accordion_accordion_items_parent_id_idx").on(
      columns._parentID,
    ),
...
export const _pages_v_blocks_accordion_accordion_items = pgTable(
  ...
  (columns) => [
    index("_pages_v_blocks_accordion_accordion_items_order_idx").on(
      columns._order,
    ),
    index("_pages_v_blocks_accordion_accordion_items_parent_id_idx").on(
      columns._parentID,
    ),
    index("_pages_v_blocks_accordion_accordion_items_icon_idx").on(
      columns.icon,
    ),
    foreignKey({
      columns: [columns["_parentID"]],
...
export const _pages_v_blocks_accordion = pgTable(
  "_pages_v_blocks_accordion",
  {
    ...
    collapsible: boolean("collapsible").default(true),
    variant:
      enum__pages_v_blocks_accordion_variant("variant").default("single"),
    _uuid: varchar("_uuid"),
    blockName: varchar("block_name"),
  },
  (columns) => [
