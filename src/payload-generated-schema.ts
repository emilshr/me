...
export const enum_pages_blocks_accordion_variant = pgEnum('enum_pages_blocks_accordion_variant', [
  'single',
  'multiple',
])
...
export const enum__pages_v_blocks_accordion_variant = pgEnum(
  'enum__pages_v_blocks_accordion_variant',
  ['single', 'multiple'],
)
...
export const pages_blocks_block_header = pgTable(
  'pages_blocks_block_header',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => [
    index('pages_blocks_block_header_order_idx').on(columns._order),
    index('pages_blocks_block_header_parent_id_idx').on(columns._parentID),
    index('pages_blocks_block_header_path_idx').on(columns._path),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_block_header_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_accordion_accordion_items = pgTable(
  'pages_blocks_accordion_accordion_items',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    ...
    topRightSubTitle: varchar('top_right_sub_title'),
    topLeftSubTitle: varchar('top_left_sub_title'),
    content: jsonb('content'),
    value: varchar('value'),
  },
  (columns) => [
    index('pages_blocks_accordion_accordion_items_order_idx').on(columns._order),
    index('pages_blocks_accordion_accordion_items_parent_id_idx').on(columns._parentID),
    index('pages_blocks_accordion_accordion_items_icon_idx').on(columns.icon),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_accordion.id],
      name: 'pages_blocks_accordion_accordion_items_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const pages_blocks_accordion = pgTable(
  'pages_blocks_accordion',
  {
    ...
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    collapsible: boolean('collapsible').default(true),
    variant: enum_pages_blocks_accordion_variant('variant').default('single'),
    blockName: varchar('block_name'),
  },
  (columns) => [
...
export const _pages_v_blocks_block_header = pgTable(
  '_pages_v_blocks_block_header',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => [
    index('_pages_v_blocks_block_header_order_idx').on(columns._order),
    index('_pages_v_blocks_block_header_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_block_header_path_idx').on(columns._path),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_block_header_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_accordion_accordion_items = pgTable(
  '_pages_v_blocks_accordion_accordion_items',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_accordion_accordion_items_order_idx').on(columns._order),
    index('_pages_v_blocks_accordion_accordion_items_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_accordion_accordion_items_icon_idx').on(columns.icon),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_accordion.id],
      name: '_pages_v_blocks_accordion_accordion_items_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const _pages_v_blocks_accordion = pgTable(
  '_pages_v_blocks_accordion',
  {
    ...
    id: serial('id').primaryKey(),
    collapsible: boolean('collapsible').default(true),
    variant: enum__pages_v_blocks_accordion_variant('variant').default('single'),
    _uuid: varchar('_uuid'),
    blockName: varchar('block_name'),
  },
  (columns) => [
...
export const experiences = pgTable(
  'experiences',
  {
    id: serial('id').primaryKey(),
    title: varchar('title').notNull(),
    companies: integer('companies_id').references(() => companies.id, {
      onDelete: 'set null',
    }),
    updatedAt: timestamp('updated_at', {
      mode: 'string',
  ...
  (columns) => [
    index('experiences_companies_idx').on(columns.companies),
...
export const links = pgTable(
  'links',
  {
    ...
    alternateLabel: varchar('alternate_label'),
  ...
  (columns) => [
    ...
    index('links_deleted_at_idx').on(columns.deletedAt),
  ],
)
...
export const companies = pgTable(
  'companies',
  {
    ...
    websiteUrl: integer('website_url_id').references(() => links.id, {
      onDelete: 'set null',
    }),
    ...
    isCurrentJob: boolean('is_current_job'),
  ...
  (columns) => [
    index('companies_website_url_idx').on(columns.websiteUrl),
...
export const relations_pages_blocks_block_header = relations(
  pages_blocks_block_header,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_block_header._parentID],
      references: [pages.id],
      relationName: '_blocks_block-header',
    }),
  }),
)
export const relations_pages_blocks_accordion_accordion_items = relations(
  pages_blocks_accordion_accordion_items,
  ({ one }) => ({
    _parentID: one(pages_blocks_accordion, {
      fields: [pages_blocks_accordion_accordion_items._parentID],
      references: [pages_blocks_accordion.id],
      relationName: 'accordionItems',
    }),
    icon: one(media, {
      fields: [pages_blocks_accordion_accordion_items.icon],
      references: [media.id],
      relationName: 'icon',
    }),
  }),
...
export const relations_pages_blocks_accordion = relations(
  ...
  ({ one, many }) => ({
    ...
    accordionItems: many(pages_blocks_accordion_accordion_items, {
      relationName: 'accordionItems',
    }),
  }),
)
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  '_blocks_block-header': many(pages_blocks_block_header, {
    relationName: '_blocks_block-header',
  }),
...
export const relations__pages_v_blocks_block_header = relations(
  _pages_v_blocks_block_header,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_block_header._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_block-header',
    }),
  }),
)
export const relations__pages_v_blocks_accordion_accordion_items = relations(
  _pages_v_blocks_accordion_accordion_items,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_accordion, {
      fields: [_pages_v_blocks_accordion_accordion_items._parentID],
      references: [_pages_v_blocks_accordion.id],
      relationName: 'accordionItems',
    }),
    icon: one(media, {
      fields: [_pages_v_blocks_accordion_accordion_items.icon],
      references: [media.id],
      relationName: 'icon',
    }),
  }),
...
export const relations__pages_v_blocks_accordion = relations(
  ...
  ({ one, many }) => ({
    ...
    accordionItems: many(_pages_v_blocks_accordion_accordion_items, {
      relationName: 'accordionItems',
    }),
  }),
)
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  '_blocks_block-header': many(_pages_v_blocks_block_header, {
    relationName: '_blocks_block-header',
  }),
...
export const relations_companies = relations(companies, ({ one }) => ({
  websiteUrl: one(links, {
    fields: [companies.websiteUrl],
    references: [links.id],
    relationName: 'websiteUrl',
  }),
}))
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_accordion_variant: typeof enum_pages_blocks_accordion_variant
  ...
  enum__pages_v_blocks_accordion_variant: typeof enum__pages_v_blocks_accordion_variant
  ...
  pages_blocks_block_header: typeof pages_blocks_block_header
  pages_blocks_accordion_accordion_items: typeof pages_blocks_accordion_accordion_items
  ...
  _pages_v_blocks_block_header: typeof _pages_v_blocks_block_header
  _pages_v_blocks_accordion_accordion_items: typeof _pages_v_blocks_accordion_accordion_items
  ...
  relations_pages_blocks_block_header: typeof relations_pages_blocks_block_header
  relations_pages_blocks_accordion_accordion_items: typeof relations_pages_blocks_accordion_accordion_items
  ...
  relations__pages_v_blocks_block_header: typeof relations__pages_v_blocks_block_header
  relations__pages_v_blocks_accordion_accordion_items: typeof relations__pages_v_blocks_accordion_accordion_items
