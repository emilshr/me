...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_accordion_variant" AS ENUM('single', 'multiple');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_accordion_variant" AS ENUM('single', 'multiple');
  ...
  CREATE TABLE "pages_blocks_block_header" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_accordion_accordion_items" (
  	...
  	"title" varchar,
  	"sub_title" varchar,
  	"top_right_title" varchar,
  	"bottom_right_sub_title" varchar,
  	"content" jsonb,
  	"value" varchar
  );
  ...
  CREATE TABLE "pages_blocks_accordion" (
  	...
  	"variant" "enum_pages_blocks_accordion_variant" DEFAULT 'single',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_block_header" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_accordion" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"collapsible" boolean DEFAULT true,
  	"variant" "enum__pages_v_blocks_accordion_variant" DEFAULT 'single',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "pages_blocks_block_header" ADD CONSTRAINT "pages_blocks_block_header_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_accordion_accordion_items" ADD CONSTRAINT "pages_blocks_accordion_accordion_items_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_block_header" ADD CONSTRAINT "_pages_v_blocks_block_header_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_accordion_accordion_items" ADD CONSTRAINT "_pages_v_blocks_accordion_accordion_items_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "experiences" ADD CONSTRAINT "experiences_companies_id_companies_id_fk" FOREIGN KEY ("companies_id") REFERENCES "public"."companies"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "companies" ADD CONSTRAINT "companies_website_url_id_links_id_fk" FOREIGN KEY ("website_url_id") REFERENCES "public"."links"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_block_header_order_idx" ON "pages_blocks_block_header" USING btree ("_order");
  CREATE INDEX "pages_blocks_block_header_parent_id_idx" ON "pages_blocks_block_header" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_block_header_path_idx" ON "pages_blocks_block_header" USING btree ("_path");
  ...
  CREATE INDEX "pages_blocks_accordion_accordion_items_icon_idx" ON "pages_blocks_accordion_accordion_items" USING btree ("icon_id");
  ...
  CREATE INDEX "_pages_v_blocks_block_header_order_idx" ON "_pages_v_blocks_block_header" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_block_header_parent_id_idx" ON "_pages_v_blocks_block_header" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_block_header_path_idx" ON "_pages_v_blocks_block_header" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_accordion_accordion_items_icon_idx" ON "_pages_v_blocks_accordion_accordion_items" USING btree ("icon_id");
  ...
  CREATE INDEX "experiences_companies_idx" ON "experiences" USING btree ("companies_id");
  ...
  CREATE INDEX "companies_website_url_idx" ON "companies" USING btree ("website_url_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_block_header" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_block_header" CASCADE;
